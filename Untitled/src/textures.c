...
void loadTextures() {
	...
	textures[TX_PLAYERCROUCH] = SDL_CreateTextureFromSurface(game.renderer, surface);
	...
	textures[TX_PLAYERIDLE1] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERIDLE2] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERIDLE3] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERIDLE4] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERJUMP] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERWALK1] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERWALK2] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERWALK3] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PLAYERWALK4] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_ROCKPLATFORM] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_TREE] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_GROUND] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_SKY] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_LANDSCAPE] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_BUSH] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CLOUD1] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CLOUD2] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_FLOWERS] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_MAPLE] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_GRASSPLATFORM] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_SMALLROCKPLATFORM] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK1] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK2] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK3] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK4] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK5] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK6] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK7] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_PIGEONWALK8] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CROWFLOAT1] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CROWFLOAT2] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CROWFLOAT3] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_CROWFLOAT4] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	SDL_RWseek(rw, 0, RW_SEEK_SET);
	surface = IMG_LoadPNG_RW(rw);
	textures[TX_SUBTITLE] = SDL_CreateTextureFromSurface(game.renderer, surface);
	SDL_FreeSurface(surface);
	SDL_RWclose(rw);
	...
	surface = TTF_RenderText_Blended(font72, "air-blue", whiteColor);
